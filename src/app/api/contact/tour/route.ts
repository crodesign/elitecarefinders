...
export async function POST(request: Request) {
    ...
    const preferredTime = `${formatDate(date)} at ${formatTime(hour, minute)}`;
    ...
    try {
        await resend.emails.send({
            ...
            replyTo: email,
            subject: `Tour Request — ${entityName}`,
            html: `
                <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
                    <h2 style="color: #239ddb;">Tour Request</h2>
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tr><td style="padding: 8px 0; color: #666;"><strong>Preferred Time</strong></td><td style="padding: 8px 0;">${preferredTime}</td></tr>
