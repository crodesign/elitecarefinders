...
export function HomeForm({ isOpen, onClose, onSave, home }: HomeFormProps) {
    ...
    // Handle form changes to set dirty
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // If successful, close is handled or dirty cleared.
        if (success) {
            onClose();
        }
    };
    ...
    return (
        <>
            <SlidePanel
                isOpen={isOpen}
                onClose={onClose}
                title={isEditing ? "Editing Home" : "Add New Home"}
                subtitle={isEditing ? (title || home?.title || "Update listing details") : "Create a new home listing"}
                fullScreen
                headerChildren={
            ...
            >
                ...
                {/* Tab Content */}
                <form id="home-form" onSubmit={handleSubmit} className="flex flex-col flex-1" onChange={handleFormChange}>
