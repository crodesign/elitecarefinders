        ...
        <>
            <section className="max-w-6xl mx-auto px-5 pb-6">
                <div className="bg-gray-100 rounded-2xl overflow-hidden">
                    {/* Header */}
                    <div className="text-center py-3 border-b-2 border-white">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4 px-6 py-5 border-b-2 border-white">
                    ...
                    <form onSubmit={handleSearch} className="flex flex-col sm:flex-row sm:items-center gap-4 px-6 py-5">
                        ...
                        <div className="flex self-start w-full sm:w-auto">
                            <input
                                type="text"
                                value={query}
                                onChange={e => setQuery(e.target.value)}
                                placeholder="Search..."
                                className="w-48 sm:w-56 border-l border-t border-b border-gray-300 rounded-l-lg px-3 py-2 text-sm outline-none text-gray-700 placeholder-gray-400 focus:border-[#239ddb]"
