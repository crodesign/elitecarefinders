...
import { faXmark, faHandHoldingHeart } from '@fortawesome/free-solid-svg-icons';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch('/api/contact/consultation', {
                ...
                body: JSON.stringify({ fullName, phone, email, neighborhood, message }),
            });
                    ...
                    {status === 'success' ? (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3">
                            ...
                            <input
                                ...
                                placeholder="Preferred neighborhood (optional)"
                            />
                            ...
                            <div className="relative">
                                <textarea
                                    ...
                                    placeholder="Please let us know what service(s) you need help with. We are here ready to assist you!"
                                />
                            </div>
